...
const QMetaObjectExtraData Loading::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Loading::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_Loading,
      qt_meta_data_Loading, &staticMetaObjectExtraData }
};
